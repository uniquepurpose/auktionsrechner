  ...
  <form method="post">
    <table>
      ...
      <tr>
       ...
       <td>EUR <?php echo number_format($out1, 2, ',', '.'); ?></td>
      </tr>
      <tr>
       <td>Mehrwertsteuer</td>
       <td><input type="text" name="i3" value="<?php echo htmlentities($i3); ?>"></td>
       <td>EUR <?php echo number_format($out2, 2, ',', '.'); ?></td>
      </tr>
      <tr>
       <td>Gesamt</td>
       <td>EUR <?php echo number_format($out4, 2, ',', '.'); ?></td>
       <td>EUR <?php echo number_format($out3, 2, ',', '.'); ?></td>
      </tr>
    </table>
  </form>
</body>
